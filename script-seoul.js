...
function setOverlayText(player, overlayTextId) {
    ...
    if (overlayTextId == 'overlay-text1') {
        switch (originalWidth) {
            case 1920: quality = "Elemental H.264 TV-FHD 16.1M"; break;
            default: quality = "Elemental H.264 TV-FHD 16.1M";
        }
    } else if (overlayTextId == 'overlay-text2') {
        switch (originalWidth) {
            case 1920: quality = "Cloud H.264 TV-FHD 15.9M"; break;
            default: quality = "Cloud H.264 TV-FHD 15.9M";
        }
    }
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const createPlayer = (playerId, srcPrefix) => {
        ...
        player.src([
            { src: `contents/seoul-tv-hd-${srcPrefix}1.mp4`, type: 'video/mp4', label: 'frame1'},
            { src: `contents/seoul-tv-hd-${srcPrefix}2.mp4`, type: 'video/mp4', label: 'frame2', selected: true}
        ]);
        return player;
    };
