...
function setOverlayText(player, overlayTextId) {
    ...
    if (overlayTextId == 'overlay-text1') {
        switch (originalWidth) {
            ...
            default: quality = "Elemental H.264 MO-FHD 4M";
        }
    } else if (overlayTextId == 'overlay-text2') {
        switch (originalWidth) {
            case 1920: quality = "Cloud H.264 MO-FHD 3.4M"; break;
            default: quality = "Cloud H.264 MO-FHD 3.4M";
        }
    }
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const createPlayer = (playerId, srcPrefix) => {
        ...
        player.src([
            { src: `contents/meridian-mo-fhd-${srcPrefix}1.mp4`, type: 'video/mp4', label: 'frame1', selected: true},
            { src: `contents/meridian-mo-fhd-${srcPrefix}2.mp4`, type: 'video/mp4', label: 'frame2'}
        ]);
        return player;
    };
