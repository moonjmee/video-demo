...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const createPlayer = (playerId, srcPrefix) => {
        ...
        player.src([
            { src: `contents/mi3-mo-fhd-${srcPrefix}2.mp4`, type: 'video/mp4', label: 'FHD' },
            { src: `contents/mi3-mo-hd-${srcPrefix}2.mp4`, type: 'video/mp4', label: 'HD', selected: true },
            { src: `contents/mi3-mo-sd-${srcPrefix}2.mp4`, type: 'video/mp4', label: 'SD' }
        ]);
        return player;
    };
